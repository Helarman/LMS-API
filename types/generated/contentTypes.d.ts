...
export interface ApiAccountAccount extends Schema.CollectionType {
  ...
  attributes: {
    usernam: Attribute.String & Attribute.Required;
...
export interface ApiCourseResultCourseResult extends Schema.CollectionType {
...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    type: Attribute.Enumeration<['lesson', 'examination']> & Attribute.Required;
